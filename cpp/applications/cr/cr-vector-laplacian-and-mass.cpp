                 ...
                 int nrhs, const mxArray *prhs[])
{
    igl::matlab::mexErrMsgTxt(nlhs>=2,
                              "At least two output arguments are needed.");
    igl::matlab::mexErrMsgTxt(nlhs<=4,
                              "At most four output arguments are allowed.");
    ...
    igl::matlab::prepare_lhs_double(M, plhs+1);
    if(nlhs>=3)
        igl::matlab::prepare_lhs_index(E, plhs+2);
    if(nlhs>=4)
        igl::matlab::prepare_lhs_double(oE, plhs+3);
}
