% function [M, E, oE] = cr_vector_laplacian(V,F,E,oE)
% CR_VECTOR_MASS Compute the Crouzeix-Raviart vector mass matrix for a
%  triangle mesh with vertices V and faces F.
...
%  the Crouzeix-Raviart vector mass matrix, two DOF per edge (first come all
